<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Ajouter un entretien — {{ $application->company_name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('interviews.store') }}">
                    ...
                    {{-- Champ caché : identifiant de la candidature --}}
                    ...
                    <div class="mb-4">
                        ...
                        <select name="result"
                            ...
                            @foreach(App\Models\Interview::RESULT_LABELS as $value => $label)
                                <option value="{{ $value }}" {{ old('result', 'pending') === $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="notes" rows="4"
                                  placeholder="Préparer des questions sur la stack technique..."
